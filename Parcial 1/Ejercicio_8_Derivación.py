...
ax1.plot(X, Y_df_progresivo, label = 'Derivada progresiva')
ax1.plot(X, Y_df_central, label = 'Derivada central', color = 'red', marker='.')
ax1.plot(X, Y_df_real, label = 'Derivada real', color = 'grey', marker='.')
ax1.legend()

ax2.set_title('Error')
ax2.plot(X, Error_derivada_progresiva, label = 'Derivada progresiva')
ax2.plot(X, Error_derivada_central, label = 'Derivada central', color = 'red', marker='.')
ax2.legend()
